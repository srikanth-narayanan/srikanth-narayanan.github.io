...
layout: post
title: Localization
subtitle: Localization of vehicle using Particle Filter (Self Driving Car)
---

# Overview
This repository contains all the code needed to complete the Localization of Kidnapped Vehicle using particle filter and bicycle motion model.
